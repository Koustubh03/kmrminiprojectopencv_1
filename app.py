...
filter_names = ['Adjustall(BSC)','Original', 'Grayscale', 'Sepia', 'Invert', 'Blur', 'Edges', 'Emboss', 'Sharpen', '3D', 'Blur Gallery', 'Distort', 'Noise', 'Pixelate', 'Render', 'Stylize', 'Opacity']
...
if uploaded_image is not None:
    try:
        ...
        if image is not None:
            ...
            # Choose a filter
            filter_name = st.selectbox('Select a filter', ['Adjustall(BSC)','Original', 'Grayscale', 'Sepia', 'Invert', 'Blur', 'Edges', 'Emboss', 'Sharpen', '3D', 'Distort', 'Noise', 'Pixelate', 'Render', 'Stylize', 'Opacity'])
            ...
            if st.button('Apply Filter'):
                ...
                watermark_text = "CV PROJECT"  # Change this to your desired watermark text
